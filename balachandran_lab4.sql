...
select category.cat_id,category.cat_name,product_name, min(t3.min_price) as Min_Price from category inner join
(select product.cat_id, product.pro_name, product.pro_name as product_name, t2.* from product inner join
